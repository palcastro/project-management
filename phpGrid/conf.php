...
define('PHPGRID_DB_USERNAME', 'projectmg');     // database user name
define('PHPGRID_DB_PASSWORD', 'funcionaono'); // database password
define('PHPGRID_DB_NAME', 'cc001'); // database name
